...
replacement = """<!-- Left Side (Dark Panel) -->
            <div class="contact-modal-left">
              ...
              <div class="contact-info-list">
                ...
                <div class="contact-info-item align-start">
                  <div class="contact-icon" style="margin-top:2px;">
                    <img src="assets/images/car.png" alt="Car" style="width: 24px; height: 24px; object-fit: contain;">
                  </div>
                  <span style="max-width: 284px;">The Meydan Hotel | Grandstand | Meydan Road, Dubai</span>
                </div>
              </div>
            </div>
...
for file in html_files:
    ...
    pattern = re.compile(r'<!-- Left Side \(Dark Panel\) -->.*?<!-- Right Side \(Form Panel\) -->', re.DOTALL)
